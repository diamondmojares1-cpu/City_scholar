...
async function fetchDashboardData() {
  ...
  // Build a set of userIds who have submitted an application
  ...
  usersSnap.docs.forEach((docSnap) => {
    ...
    // ✅ Only push to applicants table if they actually submitted an application
...
function ProfilePopup({ user, onClose }) {
  ...
  const roleColor = role === "superadmin" ? "#7c3aed" : "#3b82f6";
      ...
      <div className="profile-popup-box" onClick={e => e.stopPropagation()}>
        ...
        <div className="profile-popup-info">
          <div className="profile-popup-row">
            <FaIdBadge className="profile-popup-row-icon" />
            <div>
          ...
          <div className="profile-popup-row">
            <FaUserCircle className="profile-popup-row-icon" />
            <div>
          ...
          <div className="profile-popup-row">
            <FaShieldAlt className="profile-popup-row-icon" />
            <div>
    ...
    <div className="del-confirm-overlay" onClick={() => !isDeleting && onCancel()}>
      <div className="del-confirm-box" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="del-confirm-msg">
          ...
          <strong>"{announcementTitle || "this announcement"}"</strong>?
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    async function loadAll(user) {
      ...
      try {
        // ✅ Fetch current user's Firestore data for profile popup
